...
public class TemperatureUnitConverter {
	...
	public static void main(String[] args) {
      ...
      System.out.println("to convert farhenheit to celsius enter F");
		...
		System.out.println(" value of the temperature converted from Celsius to Farhenhiet =  "+ convertedTempInFarhenheit);
		...
		System.out.println(" value of the temperature converted from farhenheit to celsius =  "+ convertedTempInCelsius);		}
